...
plt.title('Raspodjela magnitude potresa')
...
plt.title('Broj potresa po godini')
...
plt.title('Dubina vs magnituda')
plt.xlabel('Dubina (km)')
...
plt.title('Magnituda potresa kroz vrijeme')
plt.xlabel('Datum')
plt.ylabel('Magnituda')
plt.tight_layout()
plt.show()
...
plt.title('Toplinska karta korelacije značajki')
plt.tight_layout()
plt.show()
...
cbar.set_label('Magnituda')

# Add Athens marker
plt.plot(athens_lon, athens_lat, 'b*', markersize=15, label='Atena')
...
plt.title('Prosječna magnituda potresa po mjesecu')
plt.xlabel('Mjesec')
plt.ylabel('Prosječna magnituda')
plt.tight_layout()
plt.show()
...
plt.title('Frekvencija potresa po danu u tjednu')
plt.xlabel('Dan')
plt.ylabel('Broj')
plt.tight_layout()
plt.show()
