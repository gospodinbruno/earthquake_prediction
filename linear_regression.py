...
def run_linear_regression(data):
    ...
    plt.xlabel('Stvarna magnituda')
    plt.ylabel('Predviđena magnituda')
    plt.title('Stvarna vs predviđena magnituda')
    plt.grid(True)
    plt.tight_layout()
    plt.show()
    ...
    plt.xlabel('Stvarna magnituda')
    plt.ylabel('Rezidual')
    plt.title('Reziduali vs stvarna magnituda')
    plt.grid(True)
    plt.tight_layout()
    plt.show()
    ...
    plt.axhline(0, color='red', linestyle='--')
    plt.xlabel('Predviđena magnituda')
    plt.ylabel('Rezidual')
    plt.title('Reziduali vs predviđena magnituda')
    plt.grid(True)
    plt.tight_layout()
    plt.show()
    ...
    sns.histplot(y_test, color='blue', label='Stvarno', kde=True, stat='density', bins=30, alpha=0.5)
    sns.histplot(y_pred, color='orange', label='Predviđeno', kde=True, stat='density', bins=30, alpha=0.5)
    plt.title("Raspodjela predviđene vs stvarne magnituda")
