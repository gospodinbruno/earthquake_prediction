...
plt.plot(history.history['mse'], label='Trening gubitak')
plt.plot(history.history['val_mse'], label='Validacijski gubitak')
plt.title('Gubitak modela tijekom treniranja')
plt.xlabel('Epoha')
