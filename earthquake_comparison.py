...
plt.title('Točnost: Predviđanja unutar 0.5 magnitude')
plt.xticks(rotation=45)
plt.ylabel('Postotak (%)')
plt.xlabel('Model')
plt.tight_layout()
...
plt.title('Prosječna greška predviđanja')
plt.xticks(rotation=45)
plt.ylabel('Razlika magnitude')
plt.xlabel('Model')
plt.tight_layout()
plt.show()
...
plt.title('Raspodjela točnosti predviđanja po modelu')
plt.xlabel('Model')
plt.ylabel('Postotak predviđanja (%)')
plt.legend(title='Točnost predviđanja', bbox_to_anchor=(1.05, 1))
plt.xticks(rotation=45)
plt.tight_layout()
plt.show()
